...
const Carousel = () => {
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto">
      ...
      <button
        ref={prevRef}
        className="absolute top-1/2 left-1 lg:left-[-1.5em] transform -translate-y-1/2 bg-blue-100 text-blue-700 p-4 rounded-full z-10 hover:bg-blue-200"
      >
        <FaChevronLeft />
      </button>
      <button
        ref={nextRef}
        className="absolute top-1/2 right-1 lg:right-[-1.5em] transform -translate-y-1/2 bg-blue-100 text-blue-700 p-4 rounded-full z-10 hover:bg-blue-200"
      >
        <FaChevronRight />
      </button>
    </div>
